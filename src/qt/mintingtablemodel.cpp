...
{
public:
    MintingTablePriv(CWallet *wallet, MintingTableModel *_parent):
        wallet(wallet),
        parent(_parent)
    {
    }
    ...
    KernelRecord *index(interfaces::Wallet& wallet, int idx)
    {
    ...
    QString getTxHex(interfaces::Wallet& wallet, KernelRecord *rec)
    {
