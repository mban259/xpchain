...
class ListTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_array_result(self.nodes[0].listtransactions(label="watchonly", count=100, skip=0, include_watchonly=True),
                            {"category": "receive", "amount": Decimal("1000")},
    ...
    def run_rbf_opt_in_test(self):
        ...
        outputs = {self.nodes[0].getnewaddress(): 9990}
        ...
        outputs = {self.nodes[1].getnewaddress(): 9980}
        ...
        outputs = {self.nodes[0].getnewaddress(): 9970}
        ...
        tx3_b = tx3_modified
        tx3_b.vout[0].nValue -= int(Decimal("40") * COIN)  # bump the fee
