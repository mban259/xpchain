...
- [Development guidelines](#development-guidelines)
    - [General XPChain Core](#general-xpchain-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
XPChain Core is a multi-threaded application, and deadlocks or other
...
([`valgrind.supp`](https://github.com/xpchain/xpchain/blob/master/contrib/valgrind.supp))
...
XPChain Core can be compiled with various "sanitizers" enabled, which add
 ...
 * [Issue #12691: Enable -fsanitize flags in Travis](https://github.com/xpchain/xpchain/issues/12691)
...
file descriptors it will cause problems with XPChain's `select()` loop, because
